...
function arrayRemove(arr, value) {
 ...
 const startingPoems = (e) => {
     ...
     let output = []
     while(i > 0){
         let poem = prompt("What poem would you like to take from?\nPoem 1 or Poem 2?").toLowerCase();
         let poemStr;
         if(poem == "poem 1"){
             poemStr = firstPoem;
         } else if(poem == "poem 2"){
         ...
         let num = prompt("What line would you like to take from " + poem + "?\nLines remaining:\n" + numbers);
  ...
  return (
      <div className="flexbox-container">
        <form noValidate autoComplete='off'>
            ...
            <br />
            <Button onClick={startingPoems} variant="contained" sx={{backgroundColor: "#071e24"}}>Show poems</Button>
            <div>
